...
public class BunnyTargetRenderer implements GLSurfaceView.Renderer {
    ...
    private float kBuildingScale = 5.0f;
    ...
    private void printUserData(TrackableResult result) {
        ...
        if (trackable.getName().equals("Page01")) {
            Matrix.translateM(modelViewMatrix, 0, 0.0f, 0.0f,
                    OBJECT_SCALE_FLOAT);
            Matrix.scaleM(modelViewMatrix, 0, OBJECT_SCALE_FLOAT,
                    OBJECT_SCALE_FLOAT, OBJECT_SCALE_FLOAT);
//            Matrix.rotateM(modelViewMatrix, 0, 130f, 0, 0f, 1.0f);
        ...
        } else if (trackable.getName().equals("Page03")) {

            Matrix.scaleM(modelViewMatrix, 0, kBuildingScale,
                    kBuildingScale, kBuildingScale);
            Matrix.rotateM(modelViewMatrix, 0, 0f, 0, 0f, 1.0f);
